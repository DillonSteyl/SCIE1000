...
**Task:** Modify the following program so that it prints the message "You are not tall enough to ride!" if the value of the `height` variable is less than or equal to 130.
