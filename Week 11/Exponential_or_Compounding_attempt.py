...
# Use any method you like to fill in the exponetial and compounding arrays. These arrays will be checked. 
exponential = # use exponential to store your population values for the exponential equation
compounding = # use compounding to store your population values for the compounding equation
