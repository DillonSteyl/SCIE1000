...
print("The largest number of rats in a cage A is", round(B[maxIndexB]),"at step", maxIndexB)
print("The largest number of rats in a cage A is", round(C[maxIndexC]),"at step", maxIndexC)
print("The largest number of rats in a cage A is", round(D[maxIndexD]),"at step", maxIndexD)
