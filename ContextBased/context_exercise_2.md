...
Suppose we have a spring that is stretched to 0.5m away from its equilibrium position due to the presence of a weight at the end of the spring. Note that typically, this change in displacement is represented as a negative value. When released, the weight position oscillates with a period of 0.4 seconds. 
