...
Your program should make use of two functions. The first of which should be called 'ratio', which determines what percentage of the bowel lining size is equivalent to the size of the patients tumour. The second should be called 'stages', which determines the stage of cancer and prints the required output. 
