...
class Tests(PythonTestCase):
	...
	def test_function_one(self):
		""" Function 'eulers' returns "11.22736" for input "0,10,0.5,10" """
		self.assertEqual(attempt.eulers(0,10,0.5,10), 11.22736)
		
	def test_function_two(self):
		""" Function 'eulers' returns "12.269" for input "12,12,0.1,12" """
		self.assertEqual(attempt.eulers(12,12,0.1,12), 12.269)
		
	def test_function_three(self):
		""" Function 'eulers' returns "97.44892" for input "38.2,95.9,0.1,100" """
		self.assertEqual(attempt.eulers(38.2,95.9,0.1,100), 97.44892)
	...
	def test_function_big(self):
		""" Function 'will_it_hit' returns "0, 150.34594" for input "1" """
		a, b = attempt.will_it_hit(1)
		self.assertEqual(a, 0)
		self.assertEqual(b, 150.34594)
		
	def test_function_medium(self):
		""" Function 'will_it_hit' returns "0, 150.03482" for input "0.1" """
		a, b = attempt.will_it_hit(0.1)
		self.assertEqual(a, 0)
		self.assertEqual(b, 150.03482)
		
	def test_function_small(self):
		""" Function 'will_it_hit' returns "1, 150.00375" for input "0.01" """
		a, b = attempt.will_it_hit(0.01)
		self.assertEqual(a, 1)
		self.assertEqual(b, 150.00375)
