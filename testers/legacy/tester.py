...
import cases
from cases import StudentTestCase, STUDENT_LOCALS_NAME
from results import TestResult, TutorialTestResult
from support \
...
class TutorialTester():
    ...
    def run_test(self, test_class, code_text, num_offset_lines):
        ...
        inject_to_module(cases, STUDENT_LOCALS_NAME, lcls)
        ...
        try:
            ...
            remove_from_module(cases, STUDENT_LOCALS_NAME)
